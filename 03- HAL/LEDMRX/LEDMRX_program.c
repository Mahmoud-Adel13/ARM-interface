...
void HLEDMRX_voidInit(void)
{
  ...
  MGPIO_voidSetPinDir( LEDMRX_ROW0_PIN , OUTPUT_GP_PUSHPULL_PIN_2MHZ);
  MGPIO_voidSetPinDir( LEDMRX_ROW1_PIN , OUTPUT_GP_PUSHPULL_PIN_2MHZ);
  MGPIO_voidSetPinDir( LEDMRX_ROW2_PIN , OUTPUT_GP_PUSHPULL_PIN_2MHZ);
  MGPIO_voidSetPinDir( LEDMRX_ROW3_PIN , OUTPUT_GP_PUSHPULL_PIN_2MHZ);
  MGPIO_voidSetPinDir( LEDMRX_ROW4_PIN , OUTPUT_GP_PUSHPULL_PIN_2MHZ);
  MGPIO_voidSetPinDir( LEDMRX_ROW5_PIN , OUTPUT_GP_PUSHPULL_PIN_2MHZ);
  MGPIO_voidSetPinDir( LEDMRX_ROW6_PIN , OUTPUT_GP_PUSHPULL_PIN_2MHZ);
  MGPIO_voidSetPinDir( LEDMRX_ROW7_PIN , OUTPUT_GP_PUSHPULL_PIN_2MHZ);

  MGPIO_voidSetPinDir( LEDMRX_COL0_PIN , OUTPUT_GP_PUSHPULL_PIN_2MHZ);
  MGPIO_voidSetPinDir( LEDMRX_COL1_PIN , OUTPUT_GP_PUSHPULL_PIN_2MHZ);
  MGPIO_voidSetPinDir( LEDMRX_COL2_PIN , OUTPUT_GP_PUSHPULL_PIN_2MHZ);
  MGPIO_voidSetPinDir( LEDMRX_COL3_PIN , OUTPUT_GP_PUSHPULL_PIN_2MHZ);
  MGPIO_voidSetPinDir( LEDMRX_COL4_PIN , OUTPUT_GP_PUSHPULL_PIN_2MHZ);
  MGPIO_voidSetPinDir( LEDMRX_COL5_PIN , OUTPUT_GP_PUSHPULL_PIN_2MHZ);
  MGPIO_voidSetPinDir( LEDMRX_COL6_PIN , OUTPUT_GP_PUSHPULL_PIN_2MHZ);
  MGPIO_voidSetPinDir( LEDMRX_COL7_PIN , OUTPUT_GP_PUSHPULL_PIN_2MHZ);
}
